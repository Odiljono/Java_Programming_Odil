...
public class Palindrome {
    ...
    // this way you don't need to separate variables, but you can use math to help read values from the last index. everytime i is updated by 1 it will be subtracted from the last index
    ...
    // reverse the given String by starting the i from the last index and decrementing each iteration. concatenates the characters being red from the end into the reverse String and the reverse is the same as the original str it will return true otherwise false.
