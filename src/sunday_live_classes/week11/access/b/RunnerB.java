package sunday_live_classes.week11.access.b;

public class RunnerB {
    public static void main(String[] args) {
        Mac obj = new Mac();
        System.out.println(obj.os);
//        System.out.println(obj.memory); protected is inherited in sub classes, but not accessed directly. See Mac class for inheritance part
