 ...
 */
    ...
    public static void main(String[] args) {
        ...
        DecimalFormat df = new DecimalFormat("#.##"); // if you want to format the number you would declare this object and use the format method when printing the average on lines 52 and 59
        ...
        for (int[] eachArr : nums) { // eachArr is the 1d array elements
            ...
            // System.out.println("average of " + Arrays.toString(eachArr) + " is " + df.format(average));
        ...
        //System.out.println("Total average " + df.format(sumOfAll/totalNumberOfElements));
