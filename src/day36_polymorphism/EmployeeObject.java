...
public class EmployeeObject {
    ...
    public static void main(String[] args) {
        ...
        for (Employee eachTester : employee) {
            if (eachTester instanceof Tester) {
                testers.add((Tester) eachTester);
            }
        }
        ...
        for (Employee eachDev : employee) {
            if (eachDev instanceof Developer) {
                developers.add((Developer) eachDev);
            }
        }
        ...
        for (Employee eachTester : employee) {
            if(eachTester instanceof Tester && eachTester.getSalary() > maxSalaryTester){
                maxSalaryTester = eachTester.getSalary();
            }

        }
        System.out.println("The highest Tester's salary is: $" + maxSalaryTester);
        ...
        for (Employee eachDev : employee) {
            if(eachDev instanceof Developer && eachDev.getSalary() > maxSalaryDev){
                maxSalaryDev = eachDev.getSalary();
            }

        }
        System.out.println("The highest Developer's salary is: $" + maxSalaryDev);
